...
public class PaymentTest extends BaseTest {
    ...
    public void paymentTC(){
        new CheckoutPage(driver)
                ...
                .varifyOrderPlaced(testData.getJsonData("message.successMessage"))
                .downloadInvoice();



    }
    @Test(dependsOnMethods = {"paymentTC","proceedToCheckout","addProductsToCart","loginToAccount","registerNewAccount"})
